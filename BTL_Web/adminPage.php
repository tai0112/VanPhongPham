...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <footer class="footer">
                <div class="container-fluid">
                <table class="mt-5 table table-striped table-dark table-bordered table-hover table-sm">
            <thead>
                <tr>
                    <th>Hình ảnh</th>
                    <th>Mã sản phẩm</th>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_row($result)) {
                    echo "<tr>
                        ...
                        <td>
                            <a class=' pe-2' data-bs-toggle='modal' data-bs-target='#exampleModal'><i class='fa-solid fa-xmark'></i></a>
                                ...
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        ...
                                        <div class='modal-footer'>
                                            <a class='fs-5 btn btn-primary' href='deleteProductAdmin.php?id=$row[0]'>Xoá sản phẩm $row[2]</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <a class='' href='adminPage.php?id=$row[0]'><i class='fa-solid fa-pen-to-square'></i></a>
                        </td>
